	...
	config = function()
		...
		cmp.setup({
			...
			mapping = cmp.mapping.preset.insert({
				...
				["<C-n>"] = cmp.mapping.select_prev_item(cmp_select), -- previous suggestion
				["<C-h>"] = cmp.mapping.select_next_item(cmp_select), -- next suggestion
				["<M-a>"] = cmp.mapping.select_next_item(cmp_select), -- next suggestion
				["<M-s>"] = cmp.mapping.select_next_item(cmp_select), -- next suggestion
